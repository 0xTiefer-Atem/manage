...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RandomAccessFile randomFile = new RandomAccessFile("/home/wq/1.csv", "rw");
...
//      csv头
        RandomAccessFile rf = new RandomAccessFile("/home/wq/1.csv", "rw");
        long fl = rf.length();
        rf.seek(fl);
        ...
        BufferedReader reader = new BufferedReader(new FileReader("/home/wq/1.csv"));
        reader.readLine();
        String address = "xxxx/";
        ...
        while ((line = reader.readLine()) != null ){
            ...
            if (!(yy == xx) && !ctx[0].equals("EAN")) {
                if (!gid.equals("")) {
                    RandomAccessFile rf1 = new RandomAccessFile("/home/wq/1.csv", "rw");
                    long fl1 = rf1.length();
                    rf1.seek(fl1);
